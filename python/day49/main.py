...
# username.send_keys(USERNAME,Keys.TAB,PASSWORD)
# time.sleep(5)

# sign_button = driver.find_element(By.CSS_SELECTOR,".login__form_action_container button")
# sign_button.click()
# time.sleep(5)
